...
system_install()
{
    export XBPS_ARCH=x86_64-musl && yes Y | xbps-install -Sy -R http://alpha.us.repo.voidlinux.org/current/musl -r /mnt base-system lvm2 cryptsetup grub-x86_64-efi void-repo-nonfree
