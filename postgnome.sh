...
# Utils
sudo -u $user_name sudo xbps-install -Sy baobab dconf-editor gnome-boxes gnome-calculator gnome-calendar gnome-disk-utility gnome-font-viewer gnome-maps gnome-screenshot gnome-system-log gnome-system-monitor gnome-terminal totem # Gnome
...
cp /usr/share/applications/{org.gnome.Cheese,yelp,org.freedesktop.IBus.Setup,org.gnome.Epiphany}.desktop /home/$user_name/.local/share/applicaitons/
echo "NoDisplay=true" | tee -a /home/$user_name/.local/share/applications/{org.gnome.Cheese,yelp,org.freedesktop.IBus.Setup}.desktop
sed -i "/Actions=new-window;Incognito;/aNoDisplay=true" /home/$user_name/.local/share/applications/org.gnome.Epiphany.desktop
